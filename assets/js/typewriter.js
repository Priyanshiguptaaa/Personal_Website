...
! function(t, s, e) {
    ...
    var r = {
        strings: [`<i class="fa fa-laptop text-muted pr-2"></i> Aspiring Software Developer`, `I'm a  <i class="fa pl-2 pr-2 fa-code"></i> Frontend Developer...`, `A promising Machine Learning <i class="fa fa-database pl-2 pr-2 gradient-text"></i> Engineer `, `I Love <i class="fa fa-heart     text-danger"></i> Solving Problems and Programming...`],
        stringsElement: null,
        typeSpeed: 0,
        startDelay: 0,
        backSpeed: 0,
